 ...
 *
 * Usage:
 *   node seed1.js              (normal run – upserts all temples)
 *   node seed1.js --dry-run    (parse & count rows without inserting)
 *   node seed1.js --count      (print current temple count then exit)
 *
